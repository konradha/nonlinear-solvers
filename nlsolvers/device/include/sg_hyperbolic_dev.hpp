#ifndef SG_HYPERBOLIC_DEV_HPP
#define SG_HYPERBOLIC_DEV_HPP
...
class SGEHyperbolicSolverDevice {
public:
  struct Parameters {
    uint32_t block_size;
  ...
  SGEHyperbolicSolverDevice(const int *d_row_ptr, const int *d_col_ind,
