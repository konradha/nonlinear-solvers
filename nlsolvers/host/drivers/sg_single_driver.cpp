...
// We'll assume to be taking first-order approximants for the velocity for now for all
// equations in u_tt

int main(int argc, char** argv) {
    if (argc != 11 && argc != 12) {
        std::cerr << "Usage: " << argv[0]
                  << " nx ny Lx Ly input_u0.npy input_v0.npy output_traj.npy T nt num_snapshots [input_m.npy]\n";
        std::cerr << "Example: " << argv[0]
                  << " 256 256 10.0 10.0 initial.npy velocity.npy evolution.npy 1.5 500 100\n";
        std::cerr << "Example with m(x,y): " << argv[0]
                  << " 256 256 10.0 10.0 initial.npy velocity.npy evolution.npy 1.5 500 100 coupling.npy\n";
        return 1;
    }
