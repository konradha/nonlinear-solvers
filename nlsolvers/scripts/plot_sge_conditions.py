from energies_sge import energy_sge_hyperbolic
...
def plot_initial(X, Y, u0, v0, m, params, initials_save_path):
    fig, axs = plt.subplots(figsize=(22, 7), ncols=3, subplot_kw={"projection":'3d'})
    mp = [(u0, "u0"), (v0, "v0"), (m, "m")]
...
if __name__ == '__main__':
    ...
    plot_initial(X, Y, u0, v0, m, params, save_initial_summary_path) 
