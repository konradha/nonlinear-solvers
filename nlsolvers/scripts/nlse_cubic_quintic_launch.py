...
def save_to_hdf5(run_id, run_idx, args, u0, m, traj, X, Y, elapsed_time, s1, s2, actual_seed=0):
    ...
    with h5py.File(h5_file, 'w') as f:
        ...
        meta.attrs['sigma1'] = s1
        meta.attrs['sigma2'] = s2
...
def main():
    ...
    for i in range(args.num_runs):
        ...
        h5_file = save_to_hdf5(run_id, i, args, u0, m, traj_data, X, Y, elapsed_time, args.s1, args.s2)
