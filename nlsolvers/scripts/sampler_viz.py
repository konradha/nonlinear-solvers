...
class NLSESolutionSpaceMapper:
    ...
    def map_solution_space(self, phenomena_types=None, n_samples_per_config=2, max_configs_per_type=10, 
        ...
        if phenomena_types is None:
            phenomena_types = [
                ...
                "turbulent_condensate", "topological_defect_network"
            ]
    ...
    def characterize_solution(self, field, compute_all=False):
        ...
        """
        {
        'total_power': 4.135335553597628,
        'peak_amplitude': 1.0,
        'centroid': array([-3.61890721e+00,  4.00771381e-17]),
        'radius_of_gyration': 3.0025523670888856,
        'mean_peak_distance': 1.016733697137266,
        'momentum': array([-1.07630663e-01, -1.43786184e-16]),
        'angular_momentum': 2.170936384646926e-15,
        'entropy': 3.09648754234548,
        'spectral_centroid': array([-6.05319833, -3.17921308]),
        'spectral_bandwidth': 26.501304650396094,
        'kinetic_energy': 11.932566279958355}
        }
...
def main():
    ...
    phenomena_to_map_chaotic = [
        ...
        "solitary_wave_with_ambient", "topological_defect_network", "logarithmic_singularity_adapted",
            ] 

    phenomena_to_map_defined = [
        "multi_soliton", "vortex_lattice", "dark_soliton", "multi_ring",
            ]
    ...
    for i, p_list in enumerate([phenomena_to_map_chaotic, phenomena_to_map_defined, global_phenomena]):  
        output_dir = f"comparing_sample_diversity_{p_names[i]}" 
