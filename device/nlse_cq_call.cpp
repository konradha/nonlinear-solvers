...
int main(int argc, char **argv) {
  ...
  { 
    NLSECubicQuinticSolver::Parameters params(num_snapshots, freq);
    NLSECubicQuinticSolver solver(L, u0.data(), params);
