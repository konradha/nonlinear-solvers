...
void print_usage(const char* program_name) {
    std::cerr << "Usage: " << program_name << " nx ny Lx Ly input_u0.npy output_traj.npy T nt num_snapshots\n";
    std::cerr << "Example: " << program_name << " 256 256 10.0 10.0 initial.npy evolution.npy 1.5 500 100\n";
}
